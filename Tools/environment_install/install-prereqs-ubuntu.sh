...
SITL_PKGS="libtool libxml2-dev libxslt1-dev python-dev python-pip python-setuptools python-matplotlib python-serial python-scipy python-numpy python-pyparsing xterm lcov gcovr"
ASSUME_YES=false
QUIET=false
